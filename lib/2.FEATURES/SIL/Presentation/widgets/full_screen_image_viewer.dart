              ...
              child: PageView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return GestureDetector(
                    ...
                    onScaleEnd: (_) {
                      // Solo activa _isZoomed en false si realmente no hay zoom
                      final isStillZoomed = _isMatrixZoomed(_transformationController.value);
                      setState(() => _isZoomed = isStillZoomed);
                    },
                    child: Center(
                      child: Hero(
                        tag: widget.heroTag,
